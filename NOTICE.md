...
The MIT License in [LICENSE](LICENSE) covers this project's code and
documentation. It does not cover the material below. That stays with its
owners: this project claims no rights to it and grants none.

| Material | Where | Owner |
| --- | --- | --- |
| Hero matchups, win, pick and ban rates, lane tables | `public/data/matchups.json`, the HTML excerpts in `scripts/fixtures/` | [Dotabuff](https://www.dotabuff.com/) |
...
affiliated with or endorsed by Valve, Dotabuff, STRATZ or OpenDota.
